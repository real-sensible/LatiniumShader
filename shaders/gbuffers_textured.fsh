...
#define SHADOW_BRIGHTNESS 0.75 //Light levels are multiplied by this number when the surface is in shadows [0.00 ... 1.00]
...
in vec2 texcoord;
in vec4 glcolor;
in vec3 shadowPos; //normals don't exist for particles
